...
void Paddle_2_ai(int &ball_x, int &ball_y, int &paddle_y, int &random_num) {
    if (ball_x >= 600) {
...
int main() {
    ...
    int randomNumber2 = GetRandomValue(0, 70); 
    ...
    while (WindowShouldClose() == false) {
        ...
        Paddle_2_ai(ball_x, ball_y, paddle_y_2, randomNumber2);
        Paddle_ai(ball_x, ball_y, paddle_y, randomNumber);
